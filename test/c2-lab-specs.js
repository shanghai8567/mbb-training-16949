...
const C2_LAB_BY_DAY = {
  1: {
    ...
    menuSteps: [
      ...
      "Miro：五泳道 SIPOC（供料→离线烧录→SMT→FCT→OEM），标注 FCT-04/05",
    ],
    sessionRead: "核对三条现场规则与 routing 表、问卷摘要一致。",
    audit: ["五产品 FCT 程序不得混批", "离线烧录必须在 SMT 前"],
    practice: "在 routing 表用高亮标出 SMT前离线烧录 / X-Ray SL·MP / 车身独立 FCT。",
  ...
  3: {
    ...
    practice: "为「离线烧录错版率」写操作定义 3 行 + 选图（p 或 I-MR）。",
  ...
  8: {
    ...
    menuSteps: [
      "pfmea-electronics：ADAS 离线烧录错版 + SMT U12 空洞各 1 行",
      "车身：手插继电器浮高独立行",
      "Excel Pugh 矩阵：烧录门禁方案加权",
    ],
    sessionRead: "RPN 前 5 与对策责任人、完成日。",
    audit: ["离线烧录错版 S≥9", "勿只降 O 忽略探测度"],
  ...
  9: {
    ...
    audit: ["禁止未验证直接量产", "Safe Launch 含离线烧录 0 错版"],
  ...
  10: {
    ...
    menuSteps: [
      ...
      "control-plan-electronics：离线烧录 Checksum、SPI、X-Ray、FCT 各行",
    ],
  ...
  12: {
    ...
    menuSteps: [
      "列 4 个可复制模板（离线烧录 p 图/SPI+空洞/手插/FCT）",
      "甘特：先 ADAS 线后车身线",
  ...
  14: {
    ...
    menuSteps: [
      ...
      "3min 大纲：离线烧录/SMT/X-Ray/FCT 各 1 句",
